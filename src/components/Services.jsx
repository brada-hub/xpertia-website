...
const Services = () => {
  ...
  return (
    <section id="services" className="py-24 bg-primary-light relative overflow-hidden" ref={ref}>
      {/* Background Elements */}
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-glass p-8 rounded-2xl hover:border-accent/30 transition-all group relative overflow-hidden"
              whileHover={{ y: -10 }}
            >
              ...
              <div className="w-14 h-14 bg-white/5 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border border-white/10">
                <div className="w-7 h-7 text-accent group-hover:text-white transition-colors">
                    {service.icon}
                </div>
              </div>
              ...
              <a href="#contacto" className="inline-flex items-center text-accent font-semibold group-hover:text-white transition-colors">
                Ver Detalles
